...
namespace FashionClub.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(FashionClubUserManager userManager, FashionClubSignInManager signInManager )
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = await SignInManager.PasswordSignInAsync(address.User.ToString(), model.Password, model.RememberMe, shouldLockout: false);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                MailAddress address = new MailAddress(model.Email);
                var user = new FashionClubUser { UserName = address.User, Email = model.Email,FullName=model.FirstName+" "+model.LastName };
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new FashionClubUser { UserName = model.Email, Email = model.Email };
